...
class ConfigList(HTMLComponent, GUIComponent, object):
	...
	def __init__(self, listP, session=None):
...
class CSFDConfigListScreen:

	def __init__(self, listP, session=None, on_change=None):
		...
		self['config'] = ConfigList(listP, session=session)
